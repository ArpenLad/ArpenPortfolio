...
export default function HeroSection() {
  return (
    <section
      id="hero"
      className="min-h-screen flex flex-col justify-center pt-20 animate-fade-in"
    >
          ...
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button
                asChild
                variant="outline"
                className="px-6 py-6 border-2 border-primary hover:border-primary/80 text-primary hover:text-primary/80"
              >
